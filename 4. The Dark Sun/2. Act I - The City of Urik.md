...
With that all players without a background that would make them familiar with psionics will immediately lose consciousness (it is not actually a sleep spell, but the psion is disconnecting their brains, so Elves do not avoid this outcome).  



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxNDg2ODg4MSwtMjMxNzYyOTMwLDEwOD

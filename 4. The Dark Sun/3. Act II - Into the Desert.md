...
| 5 | *Desert Song.* A slave sings of lost cities.  Morale +1 if a PC joins in with a DC 10 Charisma (Performance) check. | 
| 6 | *Good Night.* A rare peaceful night.  +1 morale. | 
| 7 | *Broken Stores.* Some of the barrels the supplies are store in are broken, causing them to be wasted -1 food/water | 
| 8 | *Dry Air.* Dry air cracks lips and hope.  -1 slave and templar morale | 
| 9 | *Death of a Slave.* A slave dies.  -1 slave.  -1 slave morale unless the party performs an act of compassion | 
| 10 | *False Alarm.* A templar raises the alarm during the night, but it's just a bone lizard.  Still, no one sleeps well that night.  -1 templar morale | 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzQwMTkxMjEsLTIxMTg4NTg3MjYsMj

...
> Calling this place a fort is a touch misleading - it is more like an armed and defended checkpoint, built - as all things are in the desert - around a small water source.  Above its ramshackle walls you see four distinct flags flying - the highest bears a silver quill and inkwell upon a red background.  Below that stand three flags, all at the same height - one a purple serpent on a black background, one a blue mellikot - the large, pillbug like creature used to pull your caravan wagon - on a golden background, and 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0MzI2MzA3OSwzNzU3ODk5NDcsLTE3MT

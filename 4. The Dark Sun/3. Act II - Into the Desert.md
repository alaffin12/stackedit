...
| Roll | Low Morale (<4) | Neutral Morale (4-6) | High Morale (>6) |
| -- | -- | -- | -- |
| 1 | *Argument in Camp* -1 morale | | |
| 2 | *Sabotage* -1 food/water | | |
| 3 | *Desertion* -1 morale, lose 1d2 slaves unless the party makes a DC 15 Wisdom (Perception) check | | |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODAzNzYzODQ4LC0yMTE4ODU4NzI2LDIwMj

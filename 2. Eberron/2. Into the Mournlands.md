...
An active colossi docent has the following qualities.  It still requires a warforged to use, but unlike true docents they do not require attunement:
***
...
Mercy has intervened, bypass the next bit and move on to the party's interaction with him.  Otherwise, if the party elects not to go down into the but instead returns to the outside:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzM1ODI2Mjk1LC0xNTIwMjA5MTksLTc1MD
Q0MjYzMl19
-->
...
#### X22. Northwest Annex
> The scent of roasted meats and spiced wine lingers as you enter a stone chamber of unsettling warmth. A long table of black marble, veined with amber, dominates the room, set meticulously for a grand feast. Golden goblets shimmer with deep red wine, and silver platters bear glistening cuts of meat, spiced roots, and honeyed fruits not seen in any mortal land. Eight high-backed chairs encircle the table, each bearing a softly glowing sigil above its headrest — symbols of long-forgotten archmages, warlords, and seekers of forbidden knowledge.  Above, a chandelier of frozen amber hangs suspended, each crystalline branch containing a faintly flickering shadow — as if something once alive still stirs within. The walls are adorned with faded tapestries showing images of scholars partaking in strange rituals, feasting beside monstrous forms and figures cloaked in shadow.


_Wondrous item, very rare (requires attunement)_  
This ancient censer is carved from amber-veined obsidian, shaped like a snarling sphinx with its wings folded around the bowl. When lit with incense (1 gp per use), the censer releases smoke that dances with phantasmal images — glimpses of lost times, forgotten selves, and other worlds.

While attuned to the censer, you gain the following benefits:

-   #### **Veil of Echoes**
    
    While the censer is burning (10-minute duration per use), you are: Resistant to psychic damage, Immune to effects that read or detect your thoughts (such as _detect thoughts_ or telepathy), Immune to being frightened. You may use this feature once per long rest.
    

-   #### **Labyrinth Vision**
    
    Once per long rest, while inhaling the smoke, you may cast _legend lore_ without material components. However, it must target a place, not a creature or item. When cast in this way, the vision reveals a version of the target, offering cryptic insights and metaphysical truths.

- #### **Echo of the Scholar**

While attuned, you gain proficiency in Arcana, History, and Religion. If you are already proficient in any of these, your proficiency bonus is doubled for those checks.

- #### **Fractured Self**

Once per long rest, as a bonus action, you summon a translucent echo of yourself that lasts for 1 minute. It appears within 15 feet of you and mimics your movements.

-   The echo cannot attack or cast leveled spells.
    
-   You can switch places with it (no action required) once during its duration.
    
-   You may cast a cantrip _through_ the echo as if you were standing in its space.
    
-   It has AC 15 and 1 hit point. It vanishes if it takes any damage or if it ends its turn more than 30 feet from you.
    

The echo is often visually distinct — a version of you from a different path or timeline.

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0OTU4MjE5NSwtMTMzNjQzMDc2OCwtMT
Y0Mjc0MDU0NiwtMjE0MjMzNzEwMCwxMzkxNzUyODMyLDQ2NDMx
OTk5MSwtODg5MzU4MzEzLC0yNTg2NjY1OTQsLTE4Mjk1MDI4Nz
UsLTk1NTMwNTQ3OSwtMTU3MTU1NDU5MCwtMTA0MDEzODg3Miwx
MjcxMTM2NzE4LDMxNjU0MzE3NywzMzgxODExMjgsLTEzNzY1MD
I2NzIsMTgwNTAyNzU3NywyMDEwNDM0OTU1LDIxODIxNDUxNCwt
MTY1NTUwMDgzOV19
-->
...
A player studying the mural will find a hidden detail - a DC 10 Intelligence (Investigate) check reveals that there is a trail of amber inlaid into the mural, tracing a path through each pilgrim's torch.  A DC 15 Wisdom (Insight) check reveals that this path of amber could represent the path walked by the pilgrims themselves 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwNzMxOTA1MSw4ODc2OTM1MzEsMTE1Mj

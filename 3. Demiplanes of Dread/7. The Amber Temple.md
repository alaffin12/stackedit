...
-   **“Preserve the dying breath of the last true priest.”**  
    No one knows who this priest was. But the character is certain their memory, breath, or soul is hidden here — and must not be lost.
    
-   **“Recreate the feast that bound the amber.”**  
    The character becomes obsessed with gathering ingredients, re-enacting rituals, or preparing a symbolic feast that never ends.
    
-   **“Ensure the Eye in Amber never sees the same reflection twice.”**  
    The character is fixated on manipulating its position, guarding it from others, and reacting with panic if it repeats a vision.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NzI1ODk0MDAsLTUzMTk5NzI4OSwtMT

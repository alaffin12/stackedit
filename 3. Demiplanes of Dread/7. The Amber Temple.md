...
This curse cannot be removed by the "Remove Curse" spell.  Remove Curse instead dampens the curse's negative effects for three hours (if Remove Curse is cast at a higher level it dampens the curse's negative effects for a number of hours equal to the spell slot used).  Greater Restoration will remove the curse.  Alternatively, smashing the statue will remove the curse, however doing so has other effects
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0NTc4ODcxNiwtMzY4MzEzNjUxLC0xMD

...
A player studying the mural will find a hidden detail - a DC 10 Intelligence (Investigate) check reveals that there is a trail of amber inlaid into the mural, tracing a path through each pilgrim's torch.  A DC 15 Wisdom (Insight) check reveals that this path of amber could represent the path walked by the pilgrims themselves - a path of choice, of transformation and corruption.  A DC 15 Intelligence (Arcana) check reveals that the path actually echoes an arcane Mark of Binding - rare magic used to trap powerful entities.  

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzUwMjI1ODUsODg3NjkzNTMxLDExNT
IwMjI1NzYsLTE4MTk3NjUzNzEsLTM0MjQ1ODY0MCw0MTIxNDI0
NzMsLTgzNjM4MTk1Miw1NDg4NDM2NzcsNzY4MDA1OTYxLC0xNz
kwOTM2MjQxLC02Mzc1OTYzOCw1MTI4MDY3MjUsLTEyMTA4Mzk1
NTAsLTIwMTg2NzMzODUsNzcyMzk4ODM1XX0=
-->
...
The iron chest on the ceiling is held in place with sovereign glue](https://5e.tools/items.html#sovereign%20glue_dmg), and its lid is sealed with an [arcane lock](https://5e.tools/spells.html#arcane%20lock_phb) spell. The chest is impervious to weapon damage. Prying it open requires a successful DC 25 Strength check, assuming the characters can reach it. The inside of the chest is lined with lead.

If the chest's lid is opened, the floor of this room disappears (as if affected by a [disintegrate](https://5e.tools/spells.html#disintegrate_phb) spell), creating a 10-foot-square hole above [area X39](https://5e.tools/adventure.html#cos,14,x39.%20plundered%20treasury,0). Creatures standing on the floor when it disappears fall 30 feet, landing in the northwest corner of area X39.

The iron chest is empty.

https://5e.tools/adventure.html#cos,14
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzUzNjg0OTg3LC0yMzE2NDMxNzUsLTEyMj
Q4NDgwMjQsODY5NjkzMzA1LC04MDQxMDQ4NTgsMjA0MjkxOTEx
LC0xNDY3NTA4MTUxLDk5ODE4ODc2NCwxNTM2MzIwNzE5LDM1Mj
A5NTIxOSwtMzY4MzEzNjUxLC0xMDg2NzQ0NTYxLC01MzE5OTcy
ODksLTE4MDQwOTM1ODIsLTc2MTUzMDM4MCwxNzc5NDMzNjkyLC
0xMTUxMjU0ODkwLC03OTc1NzU4MzEsOTYwMjI5NzMzLDI1MjU3
NTc1XX0=
-->
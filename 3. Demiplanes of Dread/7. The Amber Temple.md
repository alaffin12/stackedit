...
This curse cannot be removed by the "Remove Curse" spell.  Remove Curse instead dampens the curse's negative effects for three hours (if Remove Curse is cast at a higher level it dampens the curse's negative effects for a number of hours equal to the spell slot used).  Greater Restoration will remove the curse.  Alternatively, smashing the statue will remove the curse but doing so in this manner has the following caveats:

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3MTM5MDE5MiwtMzY4MzEzNjUxLC0xMD

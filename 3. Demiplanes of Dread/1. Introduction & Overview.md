...
> 
> And then once voice silences all.  "You know, my masters, that I am always happy to take interesting playthings into my realm.  Send them to Barovia - to me - so they do not disturb you any further..."
>
...
## Outline
One of the Demiplanes of Dread, the Principality of Barovia is subject to the following rules:
...
I intend to use Curse of Strahd as the framework for this adventure - using it for colour, but not making players run through the whole thing.  

On arrival the party should know the following details:

* They are not in the Torvag, the Domain of Kas the Betrayer.  They have instead been sent to Barovia, the Domain of Strahd von Zarovich.
* Mordenkainen has been in Barovia before.  He was a prisoner there.  He was also aware - but did not take advantage of the opportunity to learn there.  

Hopefully the players will decide that their best chance to get out of Barovia is to find this mythical temple and make their escape (with Kas in tow).  

Barovia is very well fleshed out, and players could have an entire adventure here.  However, if they make a beeline to the Temple (which they should, assuming they can find it) their path should be straight forward - Barovia -> Tser Pool Encampment -> Old Bonegrinder -> Tsolenka Pass -> The Amber Temple - but in truth they can skip any of these except Tsolenka Pass and the Amber Temple and might find other adventures along the way.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NDcwNzM0NSwtMTIxOTgyNzQyN119
-->
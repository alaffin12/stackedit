...
[Donavich](http://journal.roll20.net/character/-Kg_Nw5fwbUiyTz3bLCL) lost the key to the iron padlock. If the chain is removed and the trapdoor is opened, the screaming in the undercroft stops. The trapdoor is swollen and stuck in its frame, so that a successful DC 12 Strength check is required to pull it open. Below it is a wooden staircase that descends 15 feet into the undercroft (area E5g).  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzIyNDMyOTUsLTEwMDQzNTA4OSwtMT

...
### Ward Runes
The arcane wards are part of the ships lockdown mode, designed to keep the pilot safe during a battle.  The wards are powered by two runes - one in area Z8 and one in Z13.  The runes are invisible, but if a creature can see invisible objects each one looks like a stylized carving of a crescent moon that pulses with a silver light.  They can be deactivated by using Dispel Magic (DC 17) or by saying the passphrase: **"the moon sings a song for the lost".**  As long as one rune remains active the bridge is inaccessible.  
...
## Stern Segment
The largest piece of the wreck, the stern segment, is nestled in Havock’s hip bones. A handful of stranded shipwreck survivors are encamped on this segment.  They were originally led by Figaro, the first mate, but a death slaad has recently killed a former passenger and infiltrated the camp in his body, sowing chaos and magically manipulating Figaro’s mind. This drove Figaro into a paranoid state, causing him to lock himself in his quarters, where one of the safe room’s ward runes is located.
...
**Heart Entryway.** The hole in this area leads into the [heart of Havock](http://journal.roll20. as shown on the Heart of Havock map and described in the following se4) There are two crew members whoction. To retrieve the spelljammer helm, the characters must venture into the heart and confront the monster inside.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5MDQxMzc5MSwtMTM2ODM1NzkyMiw4Nz
MwMzE2NDgsMTcyNDgwMjY3NF19
-->